...
In REV_6, normal distribution changed to log normal distribution in order to have ability to increase 'std_dev' (for more uncertainty) and avoid negative cost (for exaple, negative minimum cost when 'std_dev' is high)
'''
